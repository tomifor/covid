        ...
        return (
            <div className={'footer-container'}>
                <div className={'social'}>
                    ...
                    <a className={'icon'} href={'https://www.linkedin.com/in/tomasforman/'} rel={'noopener noreferrer'}
                       target={'_blank'}>
                        <svg className={'icon-linkedin'} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path
